...
export const runDataRegistrationBeforeInterview = async (
    registerData: any,
    brand: string,
    pg_mail: string,
    pg_pass: string
    ...
    const fillForm = async () => {
        ...
        // 建築動機
        await safeFill(
            page, registerObject, errors, "#customer_house_hunting_motivation",
        ...
        // 建築予定地
        await safeFill(
            page, registerObject, errors, "#customer_planned_construction_site",
            registerData.area,
            "area"
        );
        ...
        // 問合せのきっかけ
        await safeFill(
            page, registerObject, errors, "#customer_inquiry_reason",
        ...
        // 予算総額
        await safeFill(
            page, registerObject, errors, "#customer_budget",
            registerData.budget
        ...
        // 現居家賃
        await safeFill(
            page, registerObject, errors, "#customer_current_rent",
        ...
        if (registerData.employment.name) {
            try {
                ...
                await safeFill(
                    page, registerObject, errors, "#customer_customer_contacts_attributes_0_employer_name",
                    registerData.employment.name,
                    "employmentName"
                );
                await safeFill(
                    page, registerObject, errors, "#customer_customer_contacts_attributes_0_employer_address",
                    registerData.employment.address,
                    "employmentAddress"
                );
                await safeFill(
                    page, registerObject, errors, "#customer_customer_contacts_attributes_0_years_of_service",
                ...
                await safeFill(
                    page, registerObject, errors, "#customer_customer_contacts_attributes_0_annual_income",
        ...
        if (registerData.survey && registerData.survey !== "") {
            try {
                ...
                const newNote = `~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n面談前アンケート\n${registerData.survey}\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n${current}`;
                await safeFill(
                    page, registerObject, errors, "//html/body/main/div[1]/div[2]/div/form/div[1]/div[4]/div[3]/div[2]/div/div[2]/div[2]/div[1]/textarea",
                    newNote,
                    "memo"
                );
                await page.click(
