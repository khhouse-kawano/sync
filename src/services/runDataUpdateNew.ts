...
import { pgLogin, safeUpdateFill, safeGetValue, safeUpdateSelect } from '../utils/function';

const errors: string[] = [];

export const runDataUpdateNew = async (postData: any, brand: string, pg_mail: string, pg_pass: string) => {
    ...
    const fillForm = async () => {
        ...
        await page.goto(
            `https://pg-cloud.cloud/customers/${postData.id}/summary`,
        );
        ...
        for (const item of selectObject) {
            await safeUpdateSelect(page, updateObject, errors, item.path, item.value, item.label, item.parentPath, item.valuePath);
        }
        ...
        try {
            ...
            for (const item of contactObject) {
                await safeUpdateFill(page, updateObject, errors, item.path, item.value, item.label);
            }
            await page.click(
        ...
        try {
            await page.click(
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[6]/div[2]/div[2]/div/div[1]',
            );
        } catch (err) {
        ...
        const selectors = {
            ...
            zipSearchBtn:
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[6]/div[2]/div[2]/div/div[2]/div[2]/div[1]/div/div[2]/div/div[1]/div[2]/a',
            zipContent: '#customer_postal_code',
            prefContent:
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[6]/div[2]/div[2]/div/div[2]/div[2]/div[1]/div/div[2]/div/div[2]/div[1]/div/div[1]/input',
            cityContent:
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[6]/div[2]/div[2]/div/div[2]/div[2]/div[1]/div/div[2]/div/div[3]/div/div/div[1]/input',
            townContent:
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[6]/div[2]/div[2]/div/div[2]/div[2]/div[1]/div/div[2]/div/div[4]/div/div/div[1]/input',
        ...
        if (postData.postal_code) {
            ...
            if (zipValue.length === 7) {
                await safeUpdateFill(page, updateObject, errors, selectors.zipInput, postData.postal_code, 'zip');
        ...
        if (postData.full_address) {
            ...
            await safeUpdateFill(page, updateObject, errors, selectors.streetInput, streetValue, 'street');
            ...
            await safeUpdateFill(page, updateObject, errors, selectors.buildingInput, buildingValue, 'building');
        }

        try {
            await page.click(
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[6]/div[2]/div[2]/div/div[2]/div[2]/div[2]/button[1]',
            );
        } catch (err) {
            const msg = `住所の入力に失敗: ${err}`;
            console.error(msg);
        ...
        for (const item of fillObject) {
            safeUpdateFill(page, updateObject, errors, item.path, item.value, item.label);
        }
        ...
        if (postData.current_loan_balance) {
            try {
                await page.click(
                    'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[10]/div[1]/div[2]/div/div[1]',
                );
                await safeUpdateFill(page, updateObject, errors,
                    '#customer_current_loan_balance',
                    postData.current_loan_balance && String(
                        Number(postData.current_loan_balance.replace('0000', '')),
                    ),
                    'utility_costs',
                );
                await page.click(
                    'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[10]/div[1]/div[2]/div/div[2]/div[2]/div[2]/button[1]',
                );
            } catch (err) {
        ...
        if (postData.customer_contacts_employer_name) {
            try {
                await page.click(
                    'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[10]/div[3]/div[2]/div/div[1]',
                );
                if (postData.customer_contacts_employment_type) {
                    await safeUpdateSelect(
                        page,
                        postData,
                        errors,
                        '#customer_contacts_employment_type',
                        postData.customer_contacts_employment_type,
                        'employmentType',
                        'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[10]/div[3]/div[2]/div/div[2]/div[2]/div[1]/div[1]/div[2]/div/div[2]',
                        'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[10]/div[3]/div[2]/div/div[2]/div[2]/div[1]/div[1]/div[2]/div/input',
                    );
                }
                ...
                const employObject = [
                    ...
                    },
                    {
                        ...
                        value: postData.customer_contacts_years_of_service && Number(
                            postData.customer_contacts_years_of_service.replace('年', '',)),
                ...
                await page.click(
                    'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[10]/div[3]/div[2]/div/div[2]/div[2]/div[2]/button[1]',
                );
            } catch (err) {
        ...
        try {
            await page.click(
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[16]/div[1]/div/turbo-frame/div/div[1]',
            );
            const fillObject = [
                {
                    path: '#calendar_item_0_start_at',
                    value: postData.step_migration_item_01J82Z5F13B6QVM6X0TCWZHW99 && `${postData.step_migration_item_01J82Z5F13B6QVM6X0TCWZHW99.replace(
                        /\//g,
                        '-',
                    )}T00:00`,
                ...
                },
                {
                    ...
                    value: postData.step_migration_item_01J82Z5F1GQB02S1DEBZPBFDW7 && `${postData.step_migration_item_01J82Z5F1GQB02S1DEBZPBFDW7.replace(
                        /\//g,
                        '-',
                    )}T00:00`,
                ...
                },
                {
                    ...
                    value: postData.step_migration_item_01JSE75MPCGQW7V2MTY9VM4HXN && `${postData.step_migration_item_01JSE75MPCGQW7V2MTY9VM4HXN.replace(
                        /\//g,
                        '-',
                    )}T00:00`,
                ...
                },
                {
                    ...
                    value: postData.step_migration_item_01JSE0CRECT96FMYTZ1ZREC3QR && `${postData.step_migration_item_01JSE0CRECT96FMYTZ1ZREC3QR.replace(
                        /\//g,
                        '-',
                    )}T00:00`,
                ...
                },
                {
                    ...
                    value: postData.step_migration_item_01JSENACS2FC422ZHEZWNSXNYA && `${postData.step_migration_item_01JSENACS2FC422ZHEZWNSXNYA.replace(
                        /\//g,
                        '-',
                    )}T00:00`,
            ...
            await page.click(
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[16]/div[1]/div/turbo-frame/div/div[2]/div[2]/div[2]/button[1]',
            );
        } catch (err) {
        ...
        try {
            await page.click(
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[4]/div[3]/div[2]/div/div[1]',
            );
            await safeUpdateFill(
                page, updateObject, errors,
                '#customer_customized_input_values_attributes_0_value',
                postData.customized_input_01J95TC6KEES87F0YXH29AJP7K,
                'survey',
            );
            await page.click(
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[4]/div[3]/div[2]/div/div[2]/div[2]/div[2]/button[1]',
            );
        } catch (err) {
        ...
        try {
            await page.click(
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[14]/div/div/div/div[1]',
            );
            await safeUpdateFill(page, updateObject, errors, '#customer_remarks', postData.remarks, 'note');
            await page.click(
                'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[14]/div/div/div/div[2]/div[2]/div[2]/button[1]',
            );
        } catch (err) {
        ...
        if (error) {
            ...
            if (error.includes('担当者')) {
                try {
                    ...
                    await page.click(
                        `div[data-label='${postData.in_charge_store} 管理']`,
                    );
                    updateObject.staffContent = await page
                        .locator(
                            'xpath=/html/body/main/div[1]/div[2]/div/form/div[1]/div[3]/div[3]/div[2]/div/input',
                        )
    ...
    console.log(
        `${nowString}_${postData.customer_contacts_name}_アップデート完了:`,
    );
