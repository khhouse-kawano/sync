...
export const runBeforeSurvey = async (updateData: any, pg_mail: string, pg_pass: string) => {
    ...
    try {
        await axios.post("https://khg-marketing.info/dashboard/api/changeShop.php", postData, {
