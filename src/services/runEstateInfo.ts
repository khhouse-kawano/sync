...
export const runEstateInfo = async (estate_robo_id: string, estate_robo_pass: string) => {
    ...
    try {
        ...
        const response = await axios.post("https://khg-marketing.info/dashboard/api/gateway/", payload, { headers });
