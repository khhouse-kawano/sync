export const idList = [
  ...
  { shop: "PG HOUSE霧島店", mail: "pgh-kirishima@example.com" },
];
...
export const mailList = [
  { brand: '国分ハウジング', mail: 'kh@kh-group.jp' },
  { brand: 'デイジャストハウス', mail: 'djh@kh-group.jp' },
  { brand: 'なごみ工務店', mail: 'nagomi@kh-group.jp' },
  { brand: 'ニーエルホーム', mail: '2lhome@kh-group.jp' },
  { brand: 'ジャスフィーホーム', mail: 'jh@kh-group.jp' },
  { brand: 'PG HOUSE', mail: 'pgh@kh-group.jp' }
];