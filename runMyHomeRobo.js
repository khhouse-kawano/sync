...
const runMyHomeRobo = async (updateData, robo_id, robo_pass) => {
  ...
  const fillForm = async () => {
    try {
      ...
      await page.click(
        "//html/body/main/div[2]/div/div/div/div[2]/div[2]/button/a"
      );
    } catch (err) {
    ...
    try {
      ...
      await page.fill(
        ...
        updateData.firstKana !== ""
          ? updateData.firstKana
          : updateData.firstName
      );
      await page.fill(
        "#customercreateform-kana_mei",
        updateData.lastKana !== "" ? updateData.lastKana : updateData.lastName
      );
      ...
      await page.click(
        "//html/body/main/div[2]/div/div/div/div[2]/div/form/div[2]/button"
      );
    } catch (err) {
    ...
    try {
      const href = await page
        .locator(
          "//html/body/main/div[2]/div/div[2]/div/div[2]/div/div/table/tbody/tr/td[6]/a[1]"
        )
        .getAttribute("href");
      mhl_url = href;
    } catch (err) {
