...
const runDataRegistration = async (registerData, pg_mail, pg_pass) => {
    ...
    const fillForm = async () => {
        ...
        await console.log('事前アンケートの入力完了');
