...
const extractCatalogData = (text) => {
    ...
    for (const line of lines) {
        ...
        if (trimmed.startsWith("--") || trimmed.startsWith("【個人情報保護方針】"))
            break; // 不要な後半は終了
...
const runCatalogResale = async (id, pass) => {
...
exports.runCatalogResale = runCatalogResale;
