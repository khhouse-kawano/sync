...
exports.runAllGritKaeru = void 0;
...
const runAllGritKaeru = async (allgrit_id, allgrit_pass) => {
    ...
    await processData();
    await browser.close();
    await (0, sendErrorMail_1.sendErrorMail)(errors, 'runAllgrit.ts');
};
exports.runAllGritKaeru = runAllGritKaeru;
