...
const extractCustomerData = (text) => {
...
const runIeuru = async (id, pass) => {
    ...
    imapClient.connect();
    (0, sendErrorMail_1.sendErrorMail)(errors, 'runIeuru.ts');
};
exports.runIeuru = runIeuru;
