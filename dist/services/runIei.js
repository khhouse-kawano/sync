...
const runIei = async (id, pass) => {
    ...
    imapClient.connect();
    (0, sendErrorMail_1.sendErrorMail)(errors, 'runHomesResales.ts');
};
exports.runIei = runIei;
