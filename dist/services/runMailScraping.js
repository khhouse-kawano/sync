...
exports.runMailScraping = void 0;
const node_imap_1 = __importDefault(require("node-imap"));
const mailparser_1 = require("mailparser");
const function_1 = require("../utils/function");
const extractLetter_1 = require("../utils/extractLetter");
const runMailScraping = async () => {
    ...
    imapClient.once('ready', () => {
        ...
        imapClient.openBox('INBOX', true, (err) => {
            ...
            const targetDate = (0, function_1.toImapDate)(threeDaysAgo);
            const searchList = [
                            ...
                            stream.once('end', async () => {
                                try {
                                    ...
                                    for (const [key, value] of Object.entries(targetMedium?.postData ?? {})) {
                                        console.log(`${value}:${(0, extractLetter_1.extractLetter)(item.target, parsed.text ?? '', key, value, targetBase)}`);
                                    }
                                }
                                catch (err) {
...
exports.runMailScraping = runMailScraping;
