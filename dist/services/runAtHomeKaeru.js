...
const runAthomeKaeru = async (id, pass) => {
    ...
    imapClient.connect();
    await (0, sendErrorMail_1.sendErrorMail)(errors, 'runAtHomeKaeru.ts');
};
exports.runAthomeKaeru = runAthomeKaeru;
