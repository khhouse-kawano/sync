...
const runHomesKaeru = async (id, pass) => {
    ...
    imapClient.connect();
    (0, sendErrorMail_1.sendErrorMail)(errors, 'runHomesKaeru.ts');
};
exports.runHomesKaeru = runHomesKaeru;
