...
const extractPreKaeruData = (text) => {
...
const runPreKaeru = async (id, pass) => {
    ...
    imapClient.connect();
    (0, sendErrorMail_1.sendErrorMail)(errors, 'runPreKaeru.ts');
};
exports.runPreKaeru = runPreKaeru;
